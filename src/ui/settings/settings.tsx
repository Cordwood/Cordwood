...
import { findByDisplayName, findByProps, findByPrototypes } from "@webpack/filters";
...
export default function initialize() {
    ...
    Object.assign(Constants.UserSettingsSections, {
        CORDWOOD_ABOUT: "CORDWOOD_ABOUT",
        CORDWOOD_SETTINGS: "CORDWOOD_SETTINGS",
        CORDWOOD_PLUGINS: "CORDWOOD_PLUGINS",
    });

    const UserSettingsModal = findByProps("getUserSettingsSections");
    after("getUserSettingsSections", UserSettingsModal, (_, ret) => {
        ret.push({
            section: Constants.UserSettingsSections.CORDWOOD_SETTINGS,
            label: "Cordwood",
            element: SettingsView,
        });
    });

    after("getPredicateSections", findByPrototypes("getPredicateSections").prototype, (_ret, sects) => {
        const pos = sects.findIndex((e) => e.section === "changelog") - 1;

        if (pos < 0) return;

        sects.splice(pos, 0, { section: "DIVIDER" }, { section: "HEADER", label: "Cordwood" }, { section: "CORDWOOD_ABOUT", label: "About", element: AboutView }, { section: "CORDWOOD_SETTINGS", label: "Settings", element: SettingsView });
